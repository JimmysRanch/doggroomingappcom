...
export const groomingApps: GroomingApp[] = [
  {
    ...
    cons: [
      'Premium pricing at $49.95/mo (worth every penny)',
  ...
  },
  {
    ...
    cons: [
      ...
      'Extremely expensive at nearly $100/month',
